...
def get_model(point_cloud, one_hot_vec, is_training, bn_decay=None):
   ...
   #############Invariance transformation Net###########################################
    ...
    invariance_transformation_net=Invariance_Transformation_Net(point_cloud=poinr_cloud_transformed,features=features_initial,is_training=is_training,invarians_trans_param=invarians_trans_param).layer_fts[-1]
    ...
    net = tf.concat([point_cloud,invariance_transformation_net],axis=-1)
